...
public class EditClientController {
    ...
    @FXML private TextField txtNom, txtPrenom, txttel, txtEmail, txtPrix, txtQuantite, txtProduit;
    ...
    private void remplirFormulaire() {
        ...
        txtQuantite.setText(String.valueOf(courant.getQuantite())); // si renommé: getQuantite()
    ...
    private void mettreAJour() {
        ...
        try {
            ...
            courant.setQuantite(Integer.parseInt(txtQuantite.getText().trim())); // si renommé: setQuantite()
    ...
    private void retour() {
        try {
            ...
            stage.setTitle("GESTION DE CLIENT");
    ...
    private boolean valid() {
        ...
        if (isBlank(txtNom, txtPrenom, txttel, txtEmail, txtPrix, txtQuantite, txtProduit)
